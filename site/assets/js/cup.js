...
(function () {
  ...
  /* ─── التشغيل التلقائي ───
     ...
     وينطلق عند ظهور نصف الشريط لا أوّله: لو انطلق عند أول بكسل
     لسقط الطقم تحت الطيّة ولم يُرَ السقوط. ولا يُعاد إلا إذا نزل
     الظهور دون النصف ثم عاد. */
  var AUTO_MS = 2600;
  var t0 = 0;
    ...
    new IntersectionObserver(
      function (entries) {
        if (entries[0].isIntersecting) {
          ...
          /* خرج الشريط كاملاً: نوقف الحلقة ونصفّر الساعة، فمن رجع
             إليه رآه من أوله لا منتهياً */
          running = false;
          t0 = 0;
          pd = null;
          draw(0, 0);
