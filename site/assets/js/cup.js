...
(function () {
  ...
  function draw(p, tms) {
    ...
    /* نَفَس الاستقرار قصير (g حتى 0.16، أي ١٢٢px على الجوال) ثم
       ...
       الجوال و٧٢٤px على الديسكتوب، فتقرأ العين كل طور منه. والبحر
       يكتمل عند 0.86 فتبقى لحظة كريم كامل قبل انفكاك التثبيت،
       ما تشوف فيها خيطاً بين البحر وخلفية القسم */
    var dis = smooth(clamp01((g - 0.16) / 0.66));
    var flood = smooth(clamp01((g - 0.42) / 0.44));
