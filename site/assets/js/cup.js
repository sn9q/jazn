...
(function () {
  ...
  /* ─── التشغيل التلقائي ───
     ...
     وتنطلق عند ظهور ثلث الشريط: مبكّرةً كما طُلب، لا عند امتلاء
     الشاشة (جُرّب فأخّر الحركة بلا داعٍ). وسببُ ظهور الطقم
     «معلَّقاً» لم يكن التوقيت بل مسافةَ السقوط وتمركزَ المشهد،
     وكلاهما صُحّح في draw. */
  var AUTO_MS = 3400;
  var t0 = 0;
